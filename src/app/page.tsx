    ...
    <section className="h-screen flex flex-col justify-center items-center">
      {
        loader ? (
          <div role="status">
            <svg aria-hidden="true" className="w-16 h-16 text-gray-200 animate-spin dark:text-slate-500 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-5 w-auto min-w-[500px]  shadow-xl shadow-slate-500 drop-shadow-lg p-8 justify-center items-center rounded-md">
            ...
            <div className="flex gap-2 w-full items-center">
              ...
              {data?.isVerified ? (
                <button className="bg-green-600 cursor-default text-white px-8 py-1 rounded-md">Verified</button>
              ) : (
